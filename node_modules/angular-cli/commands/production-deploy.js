...
var productionDeployCommand = Command.extend({
    name: 'production:deploy',
    aliases: ['production:deploy'],
    description: (_a = ["\n    Build the app for production, commit it into a git branch,\n    setup GitHub repo and push to it\n  "], _a.raw = ["\n    Build app for production, commit it into a git branch,\n    setup GitHub repo and push to it\n  "], common_tags_1.oneLine(_a)),
    works: 'insideProject',
    availableOptions: [
        {
            name: 'message',
            ...
            type: String,
            default: "production",
            description: 'Branch name to deploy the output too.'
        }, {
            name: 'skip-build',
            type: Boolean,
            default: false,
    ...
    run: function (options, rawArgs) {
      console.log('hi');
        ...
        var destinationBranch = options.branchname;
        var ghBranch = options.branchname;
        var initialBranch;
        ...
        function checkoutGhPages() {
            return execPromise("git checkout " + ghBranch)
                .catch(createGhPagesBranch);
        }
        function removeExistingFiles() {
            return execPromise('git rm --cached -r .', execOptions)
                .catch(createGhPagesBranch);
        }
        function createGhPagesBranch() {
            return execPromise("git checkout --orphan " + ghBranch)
                ...
                .then(function () { return execPromise("git commit -m \"initial " + ghBranch + " commit\""); });
        }
        function copyFiles() {
        ...
        function pushToGitRepo() {
            return execPromise("git push origin " + ghBranch + ":" + destinationBranch);
        }
...
exports.default = productionDeployCommand;
var _a;
